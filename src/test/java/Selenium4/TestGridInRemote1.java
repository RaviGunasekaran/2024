...
public class TestGridInRemote1 {
...
//		edgeRun();
	...
	private static void chromeRun() throws MalformedURLException, InterruptedException {
		...
		WebDriver cDriver = new RemoteWebDriver(new URL("http://192.168.1.12:4444/"),cOptions);
	...
	private static void firefoxRun() throws MalformedURLException, InterruptedException {
		...
		WebDriver fDriver = new RemoteWebDriver(new URL("http://192.168.1.12:4444/"),fOptions);
	...
	private static void edgeRun() throws MalformedURLException, InterruptedException {
		...
		WebDriver eDriver = new RemoteWebDriver(new URL("http://192.168.1.12:4444/"),eOptions);
